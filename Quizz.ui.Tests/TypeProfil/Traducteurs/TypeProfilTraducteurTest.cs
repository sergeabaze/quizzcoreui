...
{
    public class TypeProfilTraducteurTest
    {
        Fixture _fixture;
        private readonly ITypeProfilTraducteur _traducteur; 

        public TypeProfilTraducteurTest(){
            _traducteur=new TypeProfilTraducteur();
            _fixture=new Fixture();
        }

        [Fact]
        public void Test_Traducteur_TypeProfil_FromListe_Success()
        {
            //Arrange
            var listedto=_fixture.Create<PagedResponse<TypeProfilDto>>();
            //Act
        ...
        [Fact]
        public void Test_Traducteur_TypeProfil_Si_Model_Null()
        {
            //Arrange
            var listedto=_fixture.Create<PagedResponse<TypeProfilDto>>();
            listedto.Model=null;
        ...
        {
            //Arrange 
            var Dto=_fixture.Create<SingleResponse<TypeProfilDto>>();
            Dto.DidError=false;
            //Act
        ...
        {
            //Arrange
            var listedto=_fixture.Create<List<TypeProfilListDto>>();
            //Act
        ...
        {
            //Arrange
            List<TypeProfilListDto> listedto=null;
            //Act
            var result=_traducteur.TraduitListeVersViewModel(listedto);
            Assert.Null(result);
        }
        ...
        {
            //Arrange
            var viewModel=_fixture.Create<TypeProfilRequetteViewModel>();
            //Act
        ...
        {
            //Arrange
            var dto=_fixture.Create<TypeProfilDto>();
            //Act
